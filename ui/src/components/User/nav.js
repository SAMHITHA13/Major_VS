            ...
            <div>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="ml-auto">
                        ...
                        {this.state.role != 'admin' && <NavDropdown.Item href={"/viewProfile/" + this.state.uid}>My Profile</NavDropdown.Item>}
                        {this.state.role != 'admin' && this.state.role != 'buyer' && <NavDropdown.Item href={"/viewMap"}>Crop Distribution</NavDropdown.Item>}    
